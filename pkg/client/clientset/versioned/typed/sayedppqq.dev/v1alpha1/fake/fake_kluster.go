...
type FakeKlusters struct {
	Fake *FakeSayedppqqV1alpha1
	ns   string
}

var klustersResource = schema.GroupVersionResource{Group: "sayedppqq.dev", Version: "v1alpha1", Resource: "klusters"}

var klustersKind = schema.GroupVersionKind{Group: "sayedppqq.dev", Version: "v1alpha1", Kind: "Kluster"}
