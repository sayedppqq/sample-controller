...
import (
	...
	scheme "github.com/sayedppqq/sample-controller/pkg/client/clientset/versioned/scheme"
...
func newKlusters(c *SayedppqqV1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
