...
import (
	...
	sayedppqqdevv1alpha1 "github.com/sayedppqq/sample-controller/pkg/apis/sayedppqq.dev/v1alpha1"
	versioned "github.com/sayedppqq/sample-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/sayedppqq/sample-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/sayedppqq/sample-controller/pkg/client/listers/sayedppqq.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SayedppqqV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SayedppqqV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&sayedppqqdevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sayedppqqdevv1alpha1.Kluster{}, f.defaultInformer)
}
